...
namespace Joranski\FilamentComments\Tests\Support\Policies;

use Illuminate\Foundation\Auth\User as AuthUser;
use Joranski\FilamentComments\Models\Comment;

/**
 * Mirrors the published Shield Comment policy for package tests.
 */
final class ShieldCommentPolicy
{
