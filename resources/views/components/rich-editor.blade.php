        ...
        <div
            ...
            x-data="richEditorFormComponent({
                        ...
                        getMentionLabelsUsing: async (mentions) => {
                            const component = Livewire.find(@js($commentPanelLivewireId))
                            ...
                            try {
                                return await component.getCommentMentionLabelsForJs({ mentions })
                            } catch {
                                return {}
                            }
                        },
                        getMentionSearchResultsUsing: async (query, char) => {
                            ...
                            try {
                                const results = await component.searchMentionUsers(query)

                                return Object.fromEntries(
                                    results.map((user) => [String(user.id), user.name]),
                                )
                            } catch {
                                return {}
                            }
                        ...
                        livewireId: @js($commentPanelLivewireId),
